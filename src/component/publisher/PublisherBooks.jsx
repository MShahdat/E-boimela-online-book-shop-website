...
const PublisherBooks = () => {
  ...
  const books = Books.filter((book) => book.publisherEn === `${nameEn}`)
  ...
  return (
    <div className='bg-white dark:bg-black dark:text-white'>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
          ...
          <img
            src={image}
            className="w-36 h-36 md:w-52 md:h-52 object-cover border-4 bg-white border-black/20 rounded-full"
          />
      ...
      <p className='mt-1 pb-2 sm:pb-4 text-black/80 text-[14px] font-bold dark:text-white tracking-wider'>{name} বইসমূহ</p>
