...
const books = Books.filter((book) => book.category === 'থ্রিলার' || book.categoryEn === 'Thriller')
    ...
    <div className='bg-fuchsia-50 dark:bg-black dark:text-white'>
      <div className='max-w-6xl mx-auto px-4 py-4'>
        <motion.h3
          ...
          initial='hidden'
          whileInView={'show'}
          className='text-2xl sm:text-3xl font-semibold tracking-wide'>Thriller Books</motion.h3>
        <motion.p h3
          variants={fadeIn('up', 0.2)}
          initial='hidden'
          whileInView={'show'}
          className='mt-0.5 pb-2 sm:pb-4 text-black/80 text-[14px] dark:text-white tracking-wider'>থ্রিলার বইসমূহ</motion.p>
