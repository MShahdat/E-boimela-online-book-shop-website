...
const GenreBooks = () => {
  ...
  const books = Books.filter((book) => book.category === `${name}` || book.categoryEn === `${category}`)
      ...
      <div className='max-w-6xl mx-auto px-4 py-8'>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
          ...
          <div className="flex flex-col items-center sm:items-start justify-center sm:justify-start space-y-2">
            ...
            <h3 className="dark:text-white/80 text-base text-black/50 font-bold">{name}</h3>
        ...
        <p className='mt-1 pb-2 sm:pb-4 text-black/80 dark:text-white text-[14px] font-bold tracking-wider'>{name} বইসমূহ</p>
